...
public class Express_Order {
	...
	public void Express_Order() throws InterruptedException {
	    ...
	    driver.findElement(By.xpath("//div//div//ul[contains(@id,'Enquiries-popup')]//li[3]")).click();
	    Thread.sleep(5000);
	    ...
	    WebElement buyer=driver.findElement(By.xpath("//div//div//div//div//div//div//div//div[@class='ant-select-selector']//span[@class='ant-select-selection-search']//input[@id='admin_buyer']"));
	    buyer.click();
	    buyer.sendKeys("Ganapathy Buyo Trade",Keys.ENTER); //drop down scroll is pending
	    Thread.sleep(3000);
	    
	    driver.findElement(By.xpath("//div//div/div//div//div//div//div[@class='ant-select-selector']//span//input[@id='admin_product']")).click();
	    Thread.sleep(5000);
	    
	    driver.findElement(By.xpath("//div//div//div//div//div//div//div//div[@class='rc-virtual-list-holder-inner']//div[@title='Bio-lubricants']")).click();
	    Thread.sleep(3000);
	    
	    driver.findElement(By.xpath("//div//div//div//div//div//div//div//div[@class='ant-select-selector']//span[@class='ant-select-selection-search']//input[@id='admin_seller']")).click();
	    Thread.sleep(3000);
	    ...
	    driver.findElement(By.xpath("//input[@id='admin_price']")).sendKeys(String.valueOf(55));Thread.sleep(3000);
	    driver.findElement(By.xpath("//input[@id='admin_tradingPrice']")).sendKeys(String.valueOf(66));Thread.sleep(3000);
	    driver.findElement(By.xpath("//input[@id='admin_quantity']")).sendKeys(String.valueOf(1010));Thread.sleep(3000);
	    ...
	    driver.findElement(By.xpath("//div[@class='ant-form-item-control-input-content']//textarea[@id='admin_remark']")).sendKeys("Automating the Express Order Add page");
	    Thread.sleep(5000);
	...
	public void action() throws InterruptedException {
	    ...
	    js.executeScript("window.scroll(0,480)");
	    Thread.sleep(5000);
	    ...
	    WebElement action=driver.findElement(By.xpath("//table[1]/tbody/tr[last()]//td[14]//div//div//button"));
	    action.click();
	    Thread.sleep(5000);
	    System.out.println("Successfully viewed to express order quote page");
	    }
